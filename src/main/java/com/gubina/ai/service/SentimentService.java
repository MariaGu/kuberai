...
import com.gubina.ai.inference.SentimentModel;
import com.gubina.ai.inference.SentimentModelLoader;
...
public class SentimentService {
    ...
    private static final double POSITIVE_THRESHOLD = 0.7d;
    private static final double NEGATIVE_THRESHOLD = 0.3d;
